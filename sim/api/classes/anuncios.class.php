 <?php
class Anuncios{
	// retorna a quantidade de anuncios cadastrados no bd
	...
	public function getUltimosAnuncios($page, $perPage, $filtros){
		 ...
		 *,
		  ...
		  FROM anuncios WHERE ".implode(' AND ', $filtrostring)." ORDER BY id DESC LIMIT $offset, $perPage");//ordena decrescente
