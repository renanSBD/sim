		...
		foreach ($anuncios as $anuncio):
			...
			<tr>
				<td>
					...
					<img src="assets/img/anuncios/<?php echo $anuncio['url']; ?>" height="50px" border="0" />
				<?php else: ?>
					<img src="assets/img/default.png" height="50px" border="0" />
				<?php endif; ?>
				</td>
				...
				</td> <!--Ações em branco por enquanto -->
			</tr>
